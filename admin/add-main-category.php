...
{	
	...
	if($obj_maincategory->insert())
	{
		$message = "Maincategory insert successfully";
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header">
              <h2 class="box-title">Add Maincategory</h2>
            </div>
            <form role="form" id="main-category" method="post">
              <?php 
			    if($message != '')
				{
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputcategory">Enter Maincategory Name :</label>
                  <input type="text" name="name" placeholder="Main category" class="validate[required] form-control" value="<?php echo $obj_maincategory->name?>">
                </div>
              </div>
              <!-- /.box-body -->
...
<script>
		jQuery(document).ready(function(){
			...
			jQuery("#main-category").validationEngine();
